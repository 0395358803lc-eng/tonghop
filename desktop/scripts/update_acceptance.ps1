...
$FingerprintScript = Join-Path $Desktop ".build\restart_fingerprint.py"
$AssetScript = Join-Path $Desktop ".build\update_asset_fingerprint.py"
$RewriteScript = Join-Path $Desktop ".build\rewrite_cloned_paths.py"
